...
For purpose of avoiding code and moving API functionality where it belongs, you need to start the server by typing `npm run startServer`. This will allow full functionality of the app.
